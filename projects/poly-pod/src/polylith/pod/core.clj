(ns polylith.pod.core
  (:require #_[fluree.crypto]
            [bencode.core :as bencode]
            [clojure.edn :as edn]
            [clojure.walk :as walk]
            [clojure.string :as str]
            [polylith.pod.commands])
    ...
    (delay
      (walk/postwalk
        #(if (ident? %)
           ...
           %)
        {:format     :edn
         :namespaces [(podify-namespace 'polylith.pod.commands 'pod.polylith.pod.commands #_'pod.fluree.crypto)]})))
